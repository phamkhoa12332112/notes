...
class DialogBoxNotification extends StatefulWidget {
  ...
  final Function(DateTime, String, bool, String?)? onSave;
...
class _DialogBoxNotificationState extends State<DialogBoxNotification> {
  ...
  @override
  void initState() {
    widget.duration = widget.duration ?? StringsManger.no_duration;
    super.initState();
  }
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            PopupMenuButton(
                              ...
                              itemBuilder: (context) => [
                                PopupMenuItem(
                                  child: const Text(StringsManger.duration_day),
                                  onTap: () {
                                    setState(() {
                                      widget.duration = StringsManger.duration_day;
                                    });
                                  },
                                ),
                                PopupMenuItem(
                                  ...
                                  onTap: () {
                                    setState(() {
                                      widget.duration = StringsManger.duration_week;
                                    });
                                  },
                                ),
                                PopupMenuItem(
                                  child:
                                      const Text(StringsManger.duration_month),
                                  onTap: () {
                                    setState(() {
                                      widget.duration = StringsManger.duration_month;
                                    });
                                  },
                                ),
                              ],
              ...
              ElevatedButton(
                  onPressed: () {
                    widget.onSave!(widget.now, widget.resultLocation,
                        widget.timeOrLocation, widget.duration);
                    Navigator.pop(context);
                  },
